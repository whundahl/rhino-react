            ...
            <div className="row">
              ...
              <div className="col-lg-6">
                <div className="mb-5">
                  ...
                  <h1>
                    <i className="icmn-home mr-3" aria-hidden="true" />Bootstrap heading
              ...
              <div className="col-lg-4">
                <div className="mb-5">
                  ...
                  <ul className="list-unstyled">
                    ...
                    <li>
                      <i className="icmn-checkmark2 mr-2" aria-hidden="true" />Faucibus porta lacus
                      fringilla vel
                    </li>
                  </ul>
                </div>
            ...
            <div className="row">
              <div className="col-lg-12">
                ...
                <p className="text-muted mb-3">
                  Add a <code>&lt;footer className="blockquote-footer"&gt;</code> for identifying
                  the source. Wrap the name of the source work in <code>&lt;cite&gt;</code>.
                </p>
                <div className="row">
