...
const plainOptions = ['Residential', 'Man. Housing', 'Single Family Rentals', 'Shopping Centers', 'Malls', 'Self Storage', 'Tripple Net', 'Gaming', 'Data Centers', 'Healthcare', 'Office', 'Industrial', 'Lodging', 'Prisions', 'Other', 'Mortgage', 'Timber', 'Infranstructure'];
